  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] bg-zinc-950/80 backdrop-blur-md border-b border-zinc-800/50 text-zinc-50 py-5 px-6 md:px-10 flex justify-between items-center">
      ...
      <div className="hidden md:flex gap-8 text-sm font-medium tracking-widest uppercase items-center">
        ...
        <a href="/#portfolio" onClick={(e) => handleScrollTo(e, '#portfolio')} className="hover:text-zinc-400 transition-colors">Portfólio</a>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <a href="/#portfolio" onClick={(e) => handleScrollTo(e, '#portfolio')} className="text-lg font-medium tracking-widest uppercase hover:text-zinc-400 transition-colors">Portfólio</a>
